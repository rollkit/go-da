...
type SubmitRequest struct {
	...
	// Types that are valid to be assigned to XOptions:
	//	*SubmitRequest_Options
	XOptions isSubmitRequest_XOptions `protobuf_oneof:"_options"`
}
...
type isSubmitRequest_XOptions interface {
	isSubmitRequest_XOptions()
	MarshalTo([]byte) (int, error)
	Size() int
}

type SubmitRequest_Options struct {
	Options []byte `protobuf:"bytes,4,opt,name=options,proto3,oneof" json:"options,omitempty"`
}

func (*SubmitRequest_Options) isSubmitRequest_XOptions() {}

func (m *SubmitRequest) GetXOptions() isSubmitRequest_XOptions {
	if m != nil {
		return m.XOptions
	}
	return nil
...
func (m *SubmitRequest) GetOptions() []byte {
	if x, ok := m.GetXOptions().(*SubmitRequest_Options); ok {
		return x.Options
	}
	return nil
}
...
var fileDescriptor_feb508392bc12c0f = []byte{
	...
	,
}
...
func (m *SubmitRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.XOptions != nil {
		{
			size := m.XOptions.Size()
			i -= size
			if _, err := m.XOptions.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *SubmitRequest_Options) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SubmitRequest_Options) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Options != nil {
		i -= len(m.Options)
...
func (m *SubmitRequest_Options) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SubmitRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.XOptions = &SubmitRequest_Options{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDa(dAtA[iNdEx:])
