...
type SubmitRequest struct {
	...
	Keyringkeyname *Keyringkeyname `protobuf:"bytes,4,opt,name=keyringkeyname,proto3" json:"keyringkeyname,omitempty"`
}
...
func (m *SubmitRequest) GetKeyringkeyname() *Keyringkeyname {
	if m != nil {
		return m.Keyringkeyname
	}
	return nil
}

type Keyringkeyname struct {
	Value []byte `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
}

func (m *Keyringkeyname) Reset()         { *m = Keyringkeyname{} }
func (m *Keyringkeyname) String() string { return proto.CompactTextString(m) }
func (*Keyringkeyname) ProtoMessage()    {}
func (*Keyringkeyname) Descriptor() ([]byte, []int) {
	return fileDescriptor_feb508392bc12c0f, []int{16}
}
func (m *Keyringkeyname) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Keyringkeyname) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Keyringkeyname.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Keyringkeyname) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Keyringkeyname.Merge(m, src)
}
func (m *Keyringkeyname) XXX_Size() int {
	return m.Size()
}
func (m *Keyringkeyname) XXX_DiscardUnknown() {
	xxx_messageInfo_Keyringkeyname.DiscardUnknown(m)
}

var xxx_messageInfo_Keyringkeyname proto.InternalMessageInfo

func (m *Keyringkeyname) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Keyringkeyname)(nil), "da.Keyringkeyname")
...
var fileDescriptor_feb508392bc12c0f = []byte{
	...
	,
}
...
func (m *SubmitRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.Keyringkeyname != nil {
		{
			size, err := m.Keyringkeyname.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Keyringkeyname) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Keyringkeyname) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Keyringkeyname) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SubmitRequest) Size() (n int) {
	...
	if m.Keyringkeyname != nil {
		l = m.Keyringkeyname.Size()
		n += 1 + l + sovDa(uint64(l))
	}
	return n
}

func (m *Keyringkeyname) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SubmitRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Keyringkeyname", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Keyringkeyname == nil {
				m.Keyringkeyname = &Keyringkeyname{}
			}
			if err := m.Keyringkeyname.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Keyringkeyname) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Keyringkeyname: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Keyringkeyname: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
